...
| [One runtime, nine data models](./talon-data-engine.md) | Rust systems engineering, protocol surfaces, packaging | **Public Code** · **Public Release** |
| [A recoverable computer for coding agents](./agent-sandbox.md) | Isolation boundaries, lifecycle design, browser/PTY/workspace integration | **Case Study** · [Browser simulation](../demo/) |
